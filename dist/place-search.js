...
window.CrowPlaceSearch={async search(Place,options){
 ...
 const photoKey=window.CrowMapKeys?.photoKey(data.photoKeySlot)||{primary:window.CROW_MAPS_KEY1||window.CROW_MAPS_KEY,backup:window.CROW_MAPS_KEY2||window.CROW_MAPS_FALLBACK_KEY,backup2:window.CROW_MAPS_KEY3||window.CROW_MAPS_FALLBACK_KEY_2}[data.photoKeySlot];
