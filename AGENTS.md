...
- The shared crow emblem is `dist/images/crow-mark.svg`, styled by `dist/brand.css` for page headers and the chat avatar, and reused as the favicon. Keep explicit image dimensions so loading cannot shift the header.
